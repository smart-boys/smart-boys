...
import com.ewo.admin.constant.SecurityConstants;
...
public class SecurityConfig {
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            if (throwable != null) {
                ServletUtil.write(response, SecurityConstants.UPGRADING, "application/json;charset=UTF-8");
            } else {
                ServletUtil.write(response, SecurityConstants.UNAUTHORIZED_MSG, "application/json;charset=UTF-8");
            }
        };
    }
